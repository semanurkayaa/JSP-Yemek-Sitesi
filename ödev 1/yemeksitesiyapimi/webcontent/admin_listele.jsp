...
<html lang="en">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagesCollapseError" aria-expanded="false" aria-controls="pagesCollapseError">
                                      DUYURU,LETİŞİM VE YORUM İŞLEMLERİ
                                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                    </a>
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                           <a class="nav-link" href="duyuru_listele.jsp">DUYURU LİSTELE</a>
                                            ...
                                            <a class="nav-link" href="#">YORUM LİSTELE</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>
  ...
  while(rs.next()) { %>
  <tr>
    <td><%=rs.getString("adminad") %></td>
    <td><%=rs.getString("adminsifre") %></td>
     <td><%=rs.getString("adminmail") %></td>
    
    <td><a href='admin_guncelleme.jsp?idadmin=<%=rs.getString("idadmin")%>'>Update<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
    <td><a href='admin_sil.jsp?idadmin=<%=rs.getString("idadmin")%>'>Delete<span class="glyphicon glyphicon-remove" style="font-size:24px; color:red;"></span></a></td>
  </tr>
  <%} %>
</table>

<a href="adminekleme.jsp" class="btn btn-primary">YENİ ADMİN  EKLE</a>
