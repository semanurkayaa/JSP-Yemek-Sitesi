    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="uye_listele.jsp">ÜYE LİSTELEa>
            ...
            <div id="layoutSidenav_content">
                <main>
                <form action="iletisim_ekleme_islem.jsp" method="post">
<br>
<label>ADRES</label>
...
<div> 
        ...
        <label>MAiL</label>
        <div><input type="text" class="form-control" id="mail" name="mail" required="" /></div>
        <label>TELEFON NUMARASI</label>
        <div><input type="text" class="form-control" id="tel" name="tel" required="" />
        
      
    </div>
 <div style="margin-top:20px">
        <button class="btn btn-info" id="btn1" >Yeni iletisim Ekle</button>
    </div>
    <script>
        $('#btn1').click(function () {
            alert('İletisim Ekleme İşlemi Yapıldı.');
