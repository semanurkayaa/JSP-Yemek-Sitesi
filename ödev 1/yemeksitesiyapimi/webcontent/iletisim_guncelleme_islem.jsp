...
sayiNesnesi.setadres(adres);
sayiNesnesi.settel(tel);
//out.println(String.valueOf(session.getAttribute("id_no")));

int id=Integer.parseInt(String.valueOf(session.getAttribute("idiletisim")));
boolean islemSonucu=islemler.iletisimupdateData(sayiNesnesi,id);
if (islemSonucu==true)
