 ...
 <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                ...
                <div class="card-body">
                    <h2 class="title">ADMÝN GÝRÝÞ</h2>
                    <form action="admin_giris_islemi.jsp" method="POST">
                        <div class="input-group">
                            <input class="input--style-2" type="text" placeholder="ADMÝN ADI" name="adminad" required="">
                        </div>
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search">
                                    ...
                                    <input class="input--style-2" type="password" placeholder="ADMÝN ÞÝFRE" name="adminsifre" required="">
