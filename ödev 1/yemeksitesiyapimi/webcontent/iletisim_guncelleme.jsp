...
String adres="Almadi";
String tel="Almadi";
ResultSet rs=sayiCrud.iletisimselectData(id);
if (rs.next()){
	mail=rs.getString("mail");
	adres=rs.getString("adres");
	tel=rs.getString("tel");
	session.setAttribute("idiletisim",id);
}
%>
    </head>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagesCollapseError" aria-expanded="false" aria-controls="pagesCollapseError">
                                      DUYURU, İLETİŞİM VE YORUM İŞLEMLERİ
                                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                                    </a>
    ...
    <div id="main">
<div class="container">
  <form action="iletisim_guncelleme_islem.jsp" method="post">
   <div>
   <label>MAİL</label>
	<div> 
   ...
   <label>TELEFON NUMARASI</label>
	<div> 
     ...
     <div style="margin-top:20px">
        <button class="btn btn-info" id="btn1">İLETİŞİMİ GÜNCELLE</button>
    </div>
    </div>
  </form>
</div>
    ...
    <script>
        $('#btn1').click(function () {
            alert('İletişim Güncelleme Işlemi Yapıldı.');
