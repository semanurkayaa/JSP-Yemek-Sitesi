...
<html lang="en">
  ...
  <tr>
    ...
    <td><%=rs.getString("uyesifre") %></td>
     <td><%=rs.getString("uyemail") %></td>
    
    <td><a href='uye_guncelleme.jsp?iduyeler=<%=rs.getString("iduyeler")%>'>Update<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
    <td><a href='uye_sil.jsp?iduyeler=<%=rs.getString("iduyeler")%>'>Delete<span class="glyphicon glyphicon-remove" style="font-size:24px; color:red;"></span></a></td>
  </tr>
  <%} %>
</table>

<a href="uyeekleme.jsp" class="btn btn-primary">YENİ ÜYE  EKLE</a>
