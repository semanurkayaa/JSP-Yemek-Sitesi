...
<html lang="en">
  ...
  <% 
  ResultSet rs=sayiCrud.iletisimselectAllData();
  while(rs.next()) { %>
  <tr>
    ...
    <td><a href='iletisim_guncelleme.jsp?idiletisim=<%=rs.getString("idiletisim")%>'>Update<span class="glyphicon glyphicon-edit" style="font-size:24px; color:green;"></span></a></td>
    <td><a href='iletisim_sil.jsp?idiletisim=<%=rs.getString("idiletisim")%>'>Delete<span class="glyphicon glyphicon-remove" style="font-size:24px; color:red;"></span></a></td>
  </tr>
  <%} %>
</table>

<a href="iletisimekleme.jsp" class="btn btn-primary">YENI İLETİŞİM EKLE</a>
