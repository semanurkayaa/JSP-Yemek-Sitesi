...
ResultSet rs=sayiCrud.uyeselectData(id);
if (rs.next()){
...
%>
    ...
    <body class="sb-nav-fixed">
     ...
     <div id="main">
<div class="container">
  <form action="uye_guncelleme_islem.jsp" method="post">
   <div>
   <label>ÜYE ADI</label>
	<div> 
   ...
   <label>ÜYE ŞİFRE</label>
	<div> 
        <input type="text" class="form-control" id="uyesifre" name="uyesifre" value="<%=uyesifre%>"/>
   ...
   <label>ÜYE MAİL</label>
    ...
    <div style="margin-top:20px">
        <button class="btn btn-info" id="btn1">ÜYE GÜNCELLE</button>
    </div>
    </div>
  </form>
</div>
    ...
    <script>
        $('#btn1').click(function () {
            alert('ÜYE GÜNCELLEME İŞLEMİ BAŞARIYLA YAPILDI..');
