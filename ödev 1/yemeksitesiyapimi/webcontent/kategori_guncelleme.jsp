...
<%
int id=Integer.parseInt(request.getParameter("idkategori"));
String kategoriad="Almadi";
ResultSet rs=sayiCrud.selectData(id);
if (rs.next()){
	kategoriad=rs.getString("kategoriad");
	session.setAttribute("idkategori",id);
}
%>
    </head>
 ...
 <div id="main">
<div class="container">
  <form action="kategori_guncelleme_islemleri.jsp" method="post">
   <div>
   <label>Kategori Adi</label>
	<div> 
        <input type="text" class="form-control" id="kategoriad" name="kategoriad" value="<%=kategoriad%>"/>
    ...
    <div style="margin-top:20px">
        <button class="btn btn-info" id="btn1">Kategori Guncelle</button>
    </div>
    </div>
  </form>
</div>
