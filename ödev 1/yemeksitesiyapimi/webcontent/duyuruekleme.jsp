    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <form action="duyuru_ekleme_islem.jsp" method="post">
<br>
...
<div> 
        ...
        <div><input type="text" class="form-control" id="duyuruicerik" name="duyuruicerik" required="" /></div>
        
   
 <div style="margin-top:20px">
        <button class="btn btn-info" id="btn1" >Yeni Duyuru Ekle</button>
    </div>
       </form>
        </div>
    <script>
        $('#btn1').click(function () {
            alert('Duyuru Ekleme İşlemi Yapıldı.');
