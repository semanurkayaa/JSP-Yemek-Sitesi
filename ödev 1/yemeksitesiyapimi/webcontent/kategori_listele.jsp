    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <form class="form-inline" method="post" action="arama.jsp">
<select id="idTur" >
	...
	ResultSet rst=sayiCrud.selectAllData();
  	while(rst.next()) 
  	{ %> 
  <option  value="<%=rst.getString("kategoriad")%>"  ><%=rst.getString("kategoriad")%></option>
  	<% } %></select>
...
<a href="kategoriekleme.jsp" class="btn btn-primary">YENI KATEGORI EKLE</a>
